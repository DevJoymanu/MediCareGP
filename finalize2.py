...
DRUG_PATTERNS = [
    ...
    (r"furosemide|frusemide|lasix", "Cardiovascular"),
    (r"spironolactone|aldactone", "Cardiovascular"),
    (r"warfarin|coumadin", "Cardiovascular"),
    (r"clopidogrel|plavix", "Cardiovascular"),
    (r"glyceryl trinitrate|gtn|nitroglycerin|nitrolingual|isosorbide", "Cardiovascular"),
    (r"digoxin|lanoxin", "Cardiovascular"),
    (r"amiodarone|cordarone", "Cardiovascular"),
    (r"diltiazem", "Cardiovascular"),
    (r"sotalol", "Cardiovascular"),
    (r"rivaroxaban|xarelto|ixarola", "Cardiovascular"),
    (r"apixaban|eliquis", "Cardiovascular"),
    (r"aspirin|acetylsalicylic acid", "Cardiovascular"),
    ...
    (r"dipyridamole|persantin", "Cardiovascular"),
    ...
    (r"captopril|fosinopril|quinapril|trandolapril", "Cardiovascular"),
    (r"felodipine|lercanidipine|lacidipine|nitrendipine", "Cardiovascular"),
    (r"edoxaban|lixiana|savaysa", "Cardiovascular"),
    # Antidiabetic
    (r"metformin", "Antidiabetic"),
    (r"glimepiride|amaryl", "Antidiabetic"),
    (r"pioglitazone|actos", "Antidiabetic"),
    (r"liraglutide|victoza|saxenda", "Antidiabetic"),
    ...
    (r"biphasic insulin|premix insulin|insulin 30|insulin 50", "Antidiabetic"),
    ...
    (r"semaglutide|ozempic|rybelsus|wegovy", "Antidiabetic"),
    (r"alogliptin|nesina|vipidia", "Antidiabetic"),
    (r"repaglinide|prandin|novonorm", "Antidiabetic"),
    # Respiratory
    (r"tiotropium|spiriva|forvent", "Respiratory"),
    ...
    (r"theophylline|aminophylline|euphyllin|sandoz theophyll", "Respiratory"),
    (r"acetylcysteine|mucomyst|fluimucil|acc |mucatak|amuco", "Respiratory"),
    ...
    (r"montelukast|singulair|sintair", "Respiratory"),
    ...
    (r"lactulose|duphalac", "GI"),
    (r"mebeverine|colofac", "GI"),
    (r"ranitidine|zantac", "GI"),
    # CNS
    (r"quetiapine|seroquel", "CNS"),
    (r"carbamazepine|tegretol", "CNS"),
    (r"sodium valproate|valproate|valproic acid|epilim|depakote", "CNS"),
    ...
    # Hormones
    (r"levothyroxine|thyroxine|eltroxin|synthroid|euthyrox", "Hormones"),
    (r"dexamethasone", "Hormones"),
    (r"hydrocortisone", "Hormones"),
    (r"methylprednisolone|solu.medrol|medrol", "Hormones"),
    (r"prednisolone", "Hormones"),
    (r"prednisone|panafcort", "Hormones"),
    (r"fludrocortisone|florinef", "Hormones"),
    (r"triamcinolone|kenalog", "Hormones"),
    (r"betamethasone", "Hormones"),
    # Antibiotics
    (r"co trimoxazole|co-trimoxazole|cotrimoxazole|sulfamethoxazole|bactrim|purbac|ilvitrim|septrin", "Antibiotics"),
    (r"nitrofurantoin|macrobid|macrodantin", "Antibiotics"),
    (r"cefuroxime|zinnat|zinacef", "Antibiotics"),
    (r"levofloxacin|levaquin|tavanic", "Antibiotics"),
    ...
    (r"azithromycin|zithromax", "Antibiotics"),
    (r"ciprofloxacin|ciprobay", "Antibiotics"),
    ...
    (r"amoxicillin.clavulanate|co.amoxiclav|augmentin|amoxyclav|clavam|adco amoxyclav", "Antibiotics"),
    (r"ceftriaxone|rocephin|medocef|biotriax", "Antibiotics"),
    (r"cefazolin|ancef", "Antibiotics"),
    (r"vancomycin|vancocin", "Antibiotics"),
    (r"gentamicin|garamycin", "Antibiotics"),
    (r"cefpodoxime|cefdinir|cefixime", "Antibiotics"),
    ...
    (r"rhze|fourfix|rifafour|rifinah|rimactazid", "HIV/TB"),
    ...
    # Urology
    (r"tamsulosin|flomax sr|uromax|omsal|beniprosin|tamsul|prostaflo", "Urology"),
    (r"finasteride|proscar|propecia", "Urology"),
    (r"sildenafil|viagra|revatio|actigra|avigra", "Urology"),
    (r"tadalafil|cialis|adcirca|adafill", "Urology"),
    ...
    # Eye/Ear
    (r"latanoprost|xalatan|monopost|atana|coatana", "Eye/Ear"),
    (r"timolol latanoprost|aglatan|xalacom|timolol.*opd|timolol.*eye|timolol.*ophthalmic", "Eye/Ear"),
    (r"bimatoprost|lumigan", "Eye/Ear"),
    (r"travoprost|travatan", "Eye/Ear"),
    (r"dorzolamide|trusopt", "Eye/Ear"),
    (r"brimonidine|alphagan|brimoct", "Eye/Ear"),
    (r"tobramycin|tobrex", "Eye/Ear"),
    (r"artificial tears|hypromellose|carmellose|lubricant eye|hydroxyethyl|sodium hyaluronate", "Eye/Ear"),
    # Emergency/Injection
    (r"adrenaline|epinephrine|epipen|jext", "Emergency/Injection"),
    (r"diclofenac", "Emergency/Injection"),
    (r"vitamin b12|cyanocobalamin|hydroxocobalamin|methylcobalamin", "Emergency/Injection"),
    (r"ceftriaxone.*inj|ceftriaxone.*vial|ceftriaxone.*amp|rocephin.*inj", "Emergency/Injection"),
    (r"ondansetron.*inj|ondansetron.*ampoule|ondansetron.*amp|ondansetron.*iv ", "Emergency/Injection"),
    (r"dexamethasone.*inj|dexamethasone.*amp|dexamethasone.*vial", "Emergency/Injection"),
    (r"hydrocortisone.*inj|hydrocortisone.*amp|solu.cortef", "Emergency/Injection"),
    (r"vitamin b12 inj|cyanocobalamin inj|hydroxocobalamin inj", "Emergency/Injection"),
    # Osteoporosis/Gout
    ...
    (r"febuxostat|uloric|adenuric", "Osteoporosis/Gout"),
    # Dermatology
    (r"^tretinoin |^tretinoin$|tretinoin cream|retin.a |retacnyl|retinoic acid|retinova", "Dermatology"),
    (r"isotretinoin|accutane|roaccutane|acnetane|acnetret|oratane", "Dermatology"),
    (r"benzoyl peroxide|panoxyl|benzac|brevoxyl|benzac", "Dermatology"),
...
def parse_gems_oct2024(filepath):
    ...
    for line in lines:
        ...
        if nappi_code in EXISTING_CODES or nappi_code in results:
            continue
        combined = generic_desc + " " + product_name + " " + strength_form
        cat = get_category(combined)
        if cat:
            desc = (product_name + " " + strength_form + " [" + generic_desc + "]").strip()
            results[nappi_code] = {"code": str(nappi_code), "desc": clean_desc(desc), "category": cat}
    return results
...
def parse_gems_jan2025(filepath):
    ...
    for line in lines:
        ...
        if cat:
            results[nappi_code] = {"code": str(nappi_code), "desc": clean_desc(rest), "category": cat}
    return results
...
def parse_discovery(filepath):
    ...
    for line in lines:
        ...
        if not parts or not re.match(r"^\d{5,8}$", parts[0]):
            continue
...
def parse_medimed(filepath):
    ...
    for line in lines:
        ...
        if cat:
            ...
            results[nappi_code] = {"code": str(nappi_code), "desc": clean_desc(desc_line), "category": cat}
    return results
...
for term, label in [
    ("co trimoxazole", "co-trimoxazole"), ("bactrim", "bactrim/purbac"), 
    ("tiotropium", "tiotropium"), ("tamsulosin", "tamsulosin"),
    ("latanoprost", "latanoprost"), ("tretinoin cream", "tretinoin"),
    ("isotretinoin", "isotretinoin"), ("ceftriaxone", "ceftriaxone"),
    ("rivaroxaban", "rivaroxaban"), ("apixaban", "apixaban")
]:
    matches = [item for item in final_list if term.lower() in item["desc"].lower()]
    print(f"{label}: {len(matches)} entries - e.g. {matches[0]['code']+' '+matches[0]['desc'][:50] if matches else 'NONE'}")

out_path = os.path.join(basedir, "nappi_codes_final3.json")
