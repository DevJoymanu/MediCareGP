...
class Consultation(models.Model):
    ...
    # ── Clinical notes ────────────────────────────────────────────────────────
    chief_complaint          = models.TextField(blank=True, null=True, verbose_name='Chief complaint (patient\'s own words)')
    subjective               = models.TextField(verbose_name='S — Subjective (History of presenting illness)')
    objective                = models.TextField(verbose_name='O — Objective (Examination findings)')
    assessment               = models.TextField(verbose_name='A — Assessment (Diagnosis)')
    differential_diagnosis   = models.TextField(blank=True, null=True, verbose_name='Differential diagnosis')
    plan                     = models.TextField(verbose_name='P — Plan (Treatment)')
